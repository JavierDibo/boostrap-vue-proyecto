  ...
  <b-navbar toggleable="md" type="dark" class="custom-navbar" fixed="top">
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav class="ml-auto">
        <b-nav-item-dropdown v-for="(section, index) in sections" :key="index" :text="section.name">
          <b-dropdown-item v-for="(component, cIndex) in section.components" :key="cIndex" :to="component.url">
            {{ component.name }}
          </b-dropdown-item>
        </b-nav-item-dropdown>
      </b-navbar-nav>
      ...
      sections: [
        {
          name: 'Layout',
          components: [
            {name: 'Sistema de Layout y Celdas', url: '/#layout'},
